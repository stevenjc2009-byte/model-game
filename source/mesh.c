...
KIT("Submarine",2,P("hull",SH_CYLINDER,AXIS_X,1.5,.6,.6,0,-.3,0,-1,3,0),P("tower",SH_BOX,AXIS_Y,.4,.35,.4,0,.15,0,0,0,0),P("periscope",SH_ROD,AXIS_Y,.08,.55,.08,0,.55,0,1,1,0),P("tail fin",SH_WEDGE,AXIS_X,.4,.4,.08,.7,-.2,0,0,3,1),P("propeller",SH_CYLINDER,AXIS_X,.3,.08,.3,.88,-.3,0,3,1,1),PAIR_Z("plane L","plane R",SH_PLATE,AXIS_Z,.5,.12,.05,.15,-.3,.38,0,3,1),P("window",SH_CYLINDER,AXIS_Z,.14,.05,.14,-.25,-.18,.3,0,1,1),P("keel",SH_PLATE,AXIS_Y,.8,.05,.18,0,-.62,0,0,3,1),P("stand",SH_BOX,AXIS_Y,.7,.1,.5,0,-.75,0,0,0,1)),
KIT("Propeller Plane",2,P("hub",SH_CYLINDER,AXIS_X,.25,.1,.25,-.85,-.1,0,-1,3,0),P("fuselage",SH_CYLINDER,AXIS_X,1.5,.4,.4,0,-.15,0,0,0,0),PAIR_Z("wing L","wing R",SH_WEDGE,AXIS_Y,.8,.12,1.4,0,-.15,.55,1,2,0),P("tail",SH_PLATE,AXIS_Z,.45,.15,.65,.65,.0,0,1,2,1),P("rudder",SH_WEDGE,AXIS_Y,.12,.45,.35,.80,.22,0,4,2,1),PAIR_Z("wheel L","wheel R",SH_WHEEL,AXIS_X,.12,.25,.25,-.2,-.30,.3,1,3,1),P("cockpit",SH_DOME,AXIS_Y,.4,.25,.3,.15,.15,0,1,1,1),P("spinner",SH_CONE,AXIS_X,.25,.25,.25,-1.05,-.1,0,0,3,1)),
...
static const kitDef kitDefsLate[6] = {
	...
	KIT("Spacecraft",4,P("core",SH_CYLINDER,AXIS_X,1.3,.5,.5,0,-.15,0,-1,0,0),P("nose",SH_CONE,AXIS_X,.5,.5,.5,-.85,-.15,0,0,0,0),PAIR_Z("pod L","pod R",SH_CYLINDER,AXIS_X,.65,.3,.3,.05,-.18,.5,0,1,1),PAIR_Z("wing L","wing R",SH_WEDGE,AXIS_Z,.7,.1,.95,.18,-.15,.48,0,2,1),PAIR_Z("engine L","engine R",SH_CONE,AXIS_X,.3,.28,.3,.78,-.18,.3,0,3,2),P("canopy",SH_DOME,AXIS_Y,.42,.25,.3,-.15,.2,0,0,1,3),P("antenna",SH_ROD,AXIS_Y,.06,.45,.06,-.15,.42,0,8,3,3)),
